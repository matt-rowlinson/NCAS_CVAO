...
plt.legend()
plt.ylabel('$O_3$ (ppb)')
plt.savefig('/users/mjr583/scratch/NCAS_CVAO/plots/atlantic_ozone_data.png', dpi=200)
plt.close()
...
plt.legend()
plt.ylabel('$O_3$ (ppb)')
plt.savefig('/users/mjr583/scratch/NCAS_CVAO/plots/atlantic_ozone_trends.png', dpi=200)
plt.close()
...
plt.plot(times[0], outputs[0][1], linestyle='-',label='Tudor Hill (Ber)',  color='r')
plt.plot(times[1], outputs[1][1], linestyle='-',label='Ragged Hill (Bar)',  color='y')
plt.plot(times[2], outputs[2][1], linestyle='-',label='Dorchester (MD)',  color='purple')
plt.plot(times[3], outputs[3][1], linestyle='-',label='Indian River (FL)',  color='brown')
plt.plot(times[4], outputs[4][1], linestyle='-',label='Carteret (NC)',  color='orange')

plt.legend()
plt.ylabel('$O_3$ (ppb)')
plt.savefig('/users/mjr583/scratch/NCAS_CVAO/plots/west_atlantic_ozone_trendonly.png', dpi=200)
plt.close()
