...
for n, df in enumerate(dfs):
    ...
    CV.plot_o3_curve_from_df(df,X, Y, output, timestep=timestep, pref=pref[n], savepath='/users/mjr583/scratch/NCAS_CVAO/plots/incNAO_')
...
plt.legend()
plt.ylabel('$O_3$ (ppb)')
#plt.savefig('/users/mjr583/scratch/NCAS_CVAO/plots/incNAO_atlantic_o3_data_trend.png', dpi=200)
plt.savefig('/users/mjr583/scratch/NCAS_CVAO/plots/new_incNAO_atlantic_o3_data_trend.png', dpi=200)
...
plt.savefig('/users/mjr583/scratch/NCAS_CVAO/plots/new_cvao_o3_precision.png', dpi=200)
plt.close()
#plt.show()
